...
var swiper1 = new Swiper(".mySwiper_22", {
  loop: true,
  spaceBetween: 10,
  slidesPerView: 4,
  freeMode: true,
...
var swiper1_2 = new Swiper(".mySwiper_2", {
  loop: true,
  spaceBetween: 10,
  navigation: {
...
let swiperServicePerView = 4;

if(document.body.clientWidth <= 500){
  swiperServicePerView = 1.2;
}
else if(document.body.clientWidth < 1200){
  swiperServicePerView = 3;
}

var swiperService = new Swiper(".swiper_service", {
  spaceBetween: 10,
  slidesPerView: swiperServicePerView,
});
...
var swiper77 = new Swiper(".mySwiper77", {
  slidesPerView: 1.5,
  spaceBetween: 20,
  navigation: {
    nextEl: ".slide77_button_next",
    prevEl: ".slide77_button_prev",
  },
  breakpoints:{
    500:{
      slidesPerView: 3.2
...
let labPlus = document.querySelector('.labPlus');
let labMinus = document.querySelector('.labMinus');
let labTxt = document.querySelector('.labaratorPlusMinus p');
...
let tabTitle = document.querySelectorAll('.labarator_tabs-title h2');
let tabDescription = document.querySelectorAll('.tabDescription');

tabTitle.forEach((el,i) => {
  el.onclick = () => {
    ...
    el.className = 'tab_title-active';
    tabDescription[i].style.display = 'flex';
  }
})

// tabDropDown

let tabSelectBtn = document.querySelectorAll('.tabSelect_btn');
let tabDropDown = document.querySelectorAll('.tabDropDown');
let isDropDownOpen = false;
let currentLabarator;
let openedWithSelectLabarator;



tabSelectBtn.forEach((el,i) => {
  el.onclick = () => {
    if (!isDropDownOpen) {
      currentLabarator = tabDropDown[i];
      tabDropDown[i].style.display = 'flex';
      isDropDownOpen = true;
    }
    else if (isDropDownOpen) {
      tabDropDown[i].style.display = 'none';
      isDropDownOpen = false;
      currentLabarator = null;
    }
    openedWithSelectLabarator = false;
  }
})
...
document.body.onclick = (e) => {
  ...
  if(currentLabarator && openedWithSelectLabarator){
    if(e.target !== currentLabarator && !currentLabarator.contains(e.target)){
      currentLabarator.style.display = 'none';
      isOpenSelect = false;
      currentLabarator = null;
    } 
  }
  else{
    openedWithSelectLabarator = true;
  }
}
...
let tabOptionsDesktop = document.querySelectorAll('.tabDropDown_block1 .tabDropDown h4');
let tabDropValueDesktop = document.querySelector('.tabDropDown_block1 .tabSelect_btn h4 span');

let optionisSelect = document.createElement('img');
optionisSelect.src = 'img/mark.svg';
tabOptionsDesktop[0].append(optionisSelect);

tabOptionsDesktop.forEach((el,i) => {
  el.onclick = () => {
    el.append(optionisSelect);
    tabDropValueDesktop.textContent = el.textContent;
  }
})
...
let tabOptionsMobile = document.querySelectorAll('.tabDropDown_block2 .tabDropDown h4');
let tabDropValueMobile = document.querySelector('.tabDropDown_block2 .tabSelect_btn h4 span');

let optionisSelect2 = document.createElement('img');
optionisSelect2.src = 'img/mark.svg';
tabOptionsMobile[0].append(optionisSelect2);

tabOptionsMobile.forEach((el,i) => {
  el.onclick = () => {
    el.append(optionisSelect2);
    tabDropValueMobile.textContent = el.textContent;
...
let footInfoPlus = document.querySelectorAll('.footer_item1 h2 > img');
let footInfoBlock = document.querySelectorAll('.foot_item_blck');
let isfootInfoBlock = false;
footInfoPlus.forEach((el,i) => {
  el.onclick = () => {
    if (!isfootInfoBlock) {
      footInfoBlock[i].style.display = 'flex';
      el.src = 'img/minus.svg';
      isfootInfoBlock = true;
    }
    else if (isfootInfoBlock) {
      footInfoBlock[i].style.display = 'none';
      el.src = 'img/plus.svg'
      isfootInfoBlock = false;
    }
  }
})
