...
let stock_filterBtn = document.querySelector('.stock_rectangleMobile');
let stock_filterMobile = document.querySelector('.stock_filterMobile');
let stock_filterClose = document.querySelector('.stock_filter-close');

stock_filterBtn.onclick = () => {
  stock_filterMobile.style.display = 'flex';
}

stock_filterClose.onclick = () => {
  stock_filterMobile.style.display = 'none';
}
